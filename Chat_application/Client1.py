...
def windows():
    ...
    #Intro Part
    global profile_name
    profile_name = Label(frame, bg=bgcolor, fg="white", text="[ Zahid Hossain ]", font=("Helvetica 15 bold"))
    profile_name.place(x=170, y=10)

    Online1_name = Label(frame, bg=bgcolor, fg="white", text="Saif Ahmed", font=("Helvetica 12 bold"))
    Online1_name.place(x=18, y=50)
    Online2_name = Label(frame, bg=bgcolor, fg="white", text="Saimoon Imran", font=("Helvetica 12 bold"))
...
def LogOut():
    ...
    disconnected = "Zahid Disconnected"
